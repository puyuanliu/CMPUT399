...
if __name__ == '__main__':
    ...
    parser.add_argument('input', help='input video file or glob mask',default='chessboard.avi')
    parser.add_argument('out', help='output calibration yaml file', default='temp.yaml')
